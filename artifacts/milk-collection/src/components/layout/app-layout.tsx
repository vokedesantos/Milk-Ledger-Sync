  ...
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col md:flex-row">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-primary text-primary-foreground">
        ...
        <Button variant="ghost" size="icon" onClick={() => setIsSidebarOpen(!isSidebarOpen)} className="text-primary-foreground hover:bg-primary/90">
      ...
      `}>
        ...
        <div className="p-4 border-t border-sidebar-border space-y-4">
          <div className="flex items-center gap-2 px-2 text-xs text-muted-foreground">
            ...
            <span>Server: {health?.status === 'ok' ? <span className="text-primary font-medium">Online</span> : <span className="text-destructive font-medium">Offline</span>}</span>
          </div>
          <div className="flex items-center justify-between px-4 py-3 bg-card rounded-lg border border-card-border">
